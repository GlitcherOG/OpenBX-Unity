...
public class SplineSegmentObject : MonoBehaviour
{
    ...
    public void SetDataLineRender(bool UpdateCubePoints)
    {
        ...
        if (UpdateCubePoints)
        {
            ...
            PatchPoints[0].transform.position = Point1;
            PatchPoints[1].transform.position = Point2;
            PatchPoints[2].transform.position = Point3;
            PatchPoints[3].transform.position = Point4;
            for (int i = 0; i < PatchPoints.Count; i++)
            {
    ...
    {
        Point1 = PatchPoints[0].transform.position;
        Point2 = PatchPoints[1].transform.position;
        Point3 = PatchPoints[2].transform.position;
        Point4 = PatchPoints[3].transform.position;
